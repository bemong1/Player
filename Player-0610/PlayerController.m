...
NSString *const LoadStateDidChangeNotification = @"LoadStateDidChangeNotification";
NSString *const PlaybackDidPlayToEndTimeNotification = @"PlaybackDidPlayToEndTimeNotification";
...
- (void)playerItemDidReachEnd {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:PlaybackDidPlayToEndTimeNotification object:self];
}
...
- (void)setPlaybackState:(PlaybackState)playbackState {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:PlaybackStateDidChangeNotification object:self];
}

- (void)setLoadState:(LoadState)loadState {
    _loadState = loadState;
    [[NSNotificationCenter defaultCenter] postNotificationName:LoadStateDidChangeNotification object:self];
}
